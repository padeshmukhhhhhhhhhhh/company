...
SECRET_KEY = 'django-insecure-fq9=@lxi7xq!o3ad-^dnkk*45e2i+1p6xa%go5)6kc71uz@wc3'
...
CORS_ALLOW_ALL_ORIGINS = True  # or specify origins you want to allow
...
CRONJOBS = [
    ('0 5 * * *', 'main.config.send_payment_reminders')
]
